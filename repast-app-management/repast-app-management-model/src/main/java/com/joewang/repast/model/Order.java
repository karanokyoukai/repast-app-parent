...
public class Order {
     ...
     * 预约时间
     */
    @Column(name = "`appointmen_time`")
    private Date appointmenTime;
     ...
     * 获取拼团活动ID
     *
     * @return group_promotion_id - 拼团活动ID
     */
